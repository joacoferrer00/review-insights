...

{
  ...
  "findings": "<exactly 3 markdown bullet points, one per top insight: **bold title** + 1–2 sentences + evidence in italics>",
  "recommendations": "<exactly 3 markdown bullet points matching the findings: starts with action verb, ends with one qualitative impact>",
